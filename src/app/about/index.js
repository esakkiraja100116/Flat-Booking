      ...
      <div className="pt-6 my-5">
        ...
        <div class="grid md:grid-cols-2 mx-auto flex items-center space-x-1 lg:max-w-7xl">
            ...
            <div className='flex gap-7 p-5'>
                ...
                <img src="/about_1.png" alt="/about_1.png" className="rounded-xl h-80 w-60 object-cover object-center mb-7" />
                <img src="/about_2.png" alt="/about_2.png" className="rounded-xl h-80 w-60 object-cover object-center mt-7" />
            </div>
